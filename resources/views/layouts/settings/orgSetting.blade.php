...
<small class="m-0 p-0">{{settings()->get("org_short_name", $default = null)}} - {{settings()->get("org_full_name", $default = null)}}</small>

<div class="col-12 setting-detail-box">
    <div class="d-block">
        <h5 class="font-weight-bold m-0 p-0">Organization Name:</h5>
        <p class="px-3">{{settings()->get("org_short_name", $default = null)}} - {{settings()->get("org_full_name", $default = null)}}</p>
    </div>
    <div class="d-block">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="org_short_name" class="form-control"
                        id="exampleInputPassword1" placeholder="Short Name" value="{{settings()->get("org_short_name", $default = null)}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="org_full_name" class="form-control"
                        id="exampleInputPassword1" placeholder="Full Name" value="{{settings()->get("org_full_name", $default = null)}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    <label for="exampleInputPassword1">Vat Number</label>
                    <input type="text" name="org_vat_number" class="form-control"
                        id="exampleInputPassword1" placeholder="Vat Number" value="{{settings()->get("org_vat_number", $default = null)}}">
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="org_email" class="form-control"
                        ...
                        value="{{settings()->get("org_email", $default = null)}}">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="sn_number" class="form-control"
                        id="exampleInputPassword1" placeholder="0001000"
                        value="{{settings()->get("sn_number", $default = null)}}">
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
