                ...
                <div class="container-fluid mt-3">
                    <div class="grid mt-1">
                        ...
                        <div class="grid-item GF18 {{ $GF18 ? 'booked' : '' }}">GF18
                            <input type="checkbox" class="seat-name " data-nums="seatGF18" value="GF18" name="seatName[]"
                                id="GF18">
                        </div>
                        ...
                        <div class="grid-item GF17 {{ $GF17 ? 'booked' : '' }}">GF17
                            <input type="checkbox" class="seat-name " data-nums="seatGF17" value="GF17" name="seatName[]"
                                id="GF17">
                        ...
                        <div class="grid-item GF16 {{ $GF16 ? 'booked' : '' }}">GF16
                            <input type="checkbox" class="seat-name " data-nums="seatGF16" value="GF16" name="seatName[]"
                                id="GF16">
                        </div>
                        ...
                        <div class="grid-item GF15 {{ $GF15 ? 'booked' : '' }}">GF15
                            <input type="checkbox" class="seat-name " data-nums="seatGF15" value="GF15" name="seatName[]"
                                id="GF15">
                        </div>
                        ...
                        <div class="grid-item GF14 {{ $GF14 ? 'booked' : '' }}">GF14
                            <input type="checkbox" class="seat-name " data-nums="seatGF14" value="GF14" name="seatName[]"
                                id="GF14">
                        </div>
                        ...
                        <div class="grid-item GF13 {{ $GF13 ? 'booked' : '' }}">GF13
                            <input type="checkbox" class="seat-name " data-nums="seatGF13" value="GF13" name="seatName[]"
                                id="GF13">
                        </div>
                        ...
                        <div class="grid-item GF12 {{ $GF12 ? 'booked' : '' }}">GF12
                            <input type="checkbox" class="seat-name " data-nums="seatGF12" value="GF12" name="seatName[]"
                                id="GF12">
                        </div>
                        ...
                        <input type="checkbox" class="seat-price  seatGF3" value="{{ settings()->get('gold_ticket_price') }}"
                            name="seatPrice[]">
                    ...
                    <div class="grid mt-1">
                        ...
                        <div class="grid-item A2 {{ $A2 ? 'booked' : '' }}">A2
                            <input type="checkbox" class="seat-name"  data-nums="seatA2" value="A2" name="seatName[]"
                                id="A2">
                        </div>
                        ...
                        <div class="grid-item A1 {{ $A1 ? 'booked' : '' }}">
                            A1
                            <input type="checkbox" class="seat-name"  data-nums="seatA1" value="A1" name="seatName[]"
                                id="A1">
                        </div>
